...
import 'package:parahumans/parahumans_lib.dart';
...
Future<void> main(List<String> args) async {
  var parser = ArgParser()
    ...
    ..addFlag('log',
        defaultsTo: false,
        negatable: false,
        help: 'Log to parahumans.log in current directory.')
    ..addOption('action',
...
class CliRunner extends Presenter<ParahumansGame> {
  ...
  /// because parahumans itself has predictable randomness, and the injected
